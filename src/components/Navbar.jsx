...
const Navbar = () => {
    ...
    return (
        <>
            <nav className={`navbar navbar-expand-lg fixed-top ${scrolled ? 'navbar-scrolled' : 'bg-body-transparent'}`}>
                        ...
                        <div className="offcanvas-body">
                            <ul className="navbar-nav justify-content-end justify-content-lg-center align-items-lg-center flex-grow-1 pe-3">
                                <li className="nav-item">
                                    <Link to="/cari-load" className="nav-link active" aria-current="page">Home</Link>
                                </li>
                                <li className="nav-item">
                                    <Link to='/cari-load/about' className="nav-link">About</Link>
                                </li>
                                <li className="nav-item">
                                    <Link to='/cari-load/contact' className="nav-link">Contact</Link>
                                </li>
                                <li className="nav-item">
                                    <Link to='/cari-load/blog' className="nav-link">Blog</Link>
                                </li>
                            </ul>
